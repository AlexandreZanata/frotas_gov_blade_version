        ...
        <form action="{{ route('logbook-permissions.update', $logbookPermission) }}" method="POST" class="space-y-6" x-data="{
            ...
            <div x-show="scope === 'secretariat'" x-cloak>
                <x-secretariat-search
                    ...
                    label="Secretarias *"
                    :selectedIds="old('secretariat_ids', $logbookPermission->secretariats->pluck('id')->toArray())"
            ...
            <div x-show="scope === 'vehicles'" x-cloak>
                <x-vehicle-search
                    name="vehicle_ids"
                    label="Veículos *"
                    :selectedIds="old('vehicle_ids', $logbookPermission->vehicles->pluck('id')->toArray())"
