<x-app-layout>
    <x-slot name="header">
        <x-ui.page-header title="Novo Agendamento de Preço" subtitle="Agendar um novo valor para um tipo de combustível" />
    </x-slot>
    ...
    <x-ui.card title="Detalhes do Agendamento">
        @php($scheduledPrice = new \App\Models\ScheduledPrice())
