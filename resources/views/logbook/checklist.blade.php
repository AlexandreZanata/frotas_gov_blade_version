<x-app-layout>
    <x-slot name="header">
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <x-ui.card title="Checklist de Segurança" subtitle="Verifique cada item antes de iniciar a corrida">
                <form action="{{ route('logbook.store-checklist-form') }}" method="POST" class="space-y-6" x-data="checklistForm()">
                    @csrf
                    ...
                    <div class="flex items-center justify-between gap-3 pt-4 border-t border-gray-200 dark:border-navy-700">
                        <a href="{{ route('logbook.vehicle-select') }}" class="text-sm text-gray-600 dark:text-navy-200 hover:text-gray-900 dark:hover:text-navy-50 hover:underline">
                            ← Voltar à Seleção
                        </a>
                        <x-primary-button icon="check" compact @click="$dispatch('submit-form')">
                            Salvar e Iniciar Corrida
                        </x-primary-button>
                    </div>
                </form>
            </x-ui.card>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-blue-800 dark:text-blue-200 mt-1">
                                Ao salvar o checklist, a corrida será criada automaticamente e você poderá iniciar sua viagem.
                            </p>
                        </div>
                    </div>
                </div>
